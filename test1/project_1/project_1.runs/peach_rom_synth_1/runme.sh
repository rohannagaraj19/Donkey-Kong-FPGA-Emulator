...
HD_PWD='C:/Users/rohan/385FinalProject/test1/project_1/project_1.runs/peach_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log peach_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source peach_rom.tcl
