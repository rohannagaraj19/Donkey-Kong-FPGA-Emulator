...
HD_PWD='C:/Users/rohan/385FinalProject/test1/project_1/project_1.runs/dk2small_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dk2small_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dk2small_rom.tcl
