...
HD_PWD='C:/Users/rohan/385FinalProject/test1/project_1/project_1.runs/startScreen_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log startScreen_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source startScreen_rom.tcl
