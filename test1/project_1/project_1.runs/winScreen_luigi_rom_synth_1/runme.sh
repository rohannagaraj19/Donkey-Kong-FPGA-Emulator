...
HD_PWD='C:/Users/rohan/385FinalProject/test1/project_1/project_1.runs/winScreen_luigi_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log winScreen_luigi_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source winScreen_luigi_rom.tcl
