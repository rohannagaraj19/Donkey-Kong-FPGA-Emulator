...
#
# Generated by export_simulation on Wed May 01 23:00:56 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './winsScreen_rom.sh' script.

./winsScreen_rom.sh -reset_run
...
./winsScreen_rom.sh -noclean_files

For more information on the script, please type './winsScreen_rom.sh -help'.
