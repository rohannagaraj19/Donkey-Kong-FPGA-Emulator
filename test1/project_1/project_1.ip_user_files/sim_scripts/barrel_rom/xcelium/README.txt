...
#
# Generated by export_simulation on Sun Apr 28 21:26:08 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './barrel_rom.sh' script.

./barrel_rom.sh -reset_run
...
./barrel_rom.sh -noclean_files

For more information on the script, please type './barrel_rom.sh -help'.
