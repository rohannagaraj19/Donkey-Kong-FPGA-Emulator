...
#
# Generated by export_simulation on Wed May 01 18:29:48 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './startScreen_rom.sh' script.

./startScreen_rom.sh -reset_run
...
./startScreen_rom.sh -noclean_files

For more information on the script, please type './startScreen_rom.sh -help'.
