...
#
# Generated by export_simulation on Mon Apr 22 13:47:25 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './dk2small_rom.sh' script.

./dk2small_rom.sh -reset_run
...
./dk2small_rom.sh -noclean_files

For more information on the script, please type './dk2small_rom.sh -help'.
