...
#
# Generated by export_simulation on Wed May 01 22:51:51 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './endScreen_rom.sh' script.

./endScreen_rom.sh -reset_run
...
./endScreen_rom.sh -noclean_files

For more information on the script, please type './endScreen_rom.sh -help'.
