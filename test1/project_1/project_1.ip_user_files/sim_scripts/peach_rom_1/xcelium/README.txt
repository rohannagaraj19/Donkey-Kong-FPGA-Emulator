...
#
# Generated by export_simulation on Fri Apr 26 15:21:25 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './peach_rom.sh' script.

./peach_rom.sh -reset_run
...
./peach_rom.sh -noclean_files

For more information on the script, please type './peach_rom.sh -help'.
