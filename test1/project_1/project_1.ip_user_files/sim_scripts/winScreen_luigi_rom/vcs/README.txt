...
#
# Generated by export_simulation on Thu May 02 00:49:07 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './winScreen_luigi_rom.sh' script.

./winScreen_luigi_rom.sh -reset_run
...
./winScreen_luigi_rom.sh -noclean_files

For more information on the script, please type './winScreen_luigi_rom.sh -help'.
