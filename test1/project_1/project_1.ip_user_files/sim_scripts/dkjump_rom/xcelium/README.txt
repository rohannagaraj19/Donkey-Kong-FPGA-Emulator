...
#
# Generated by export_simulation on Sat Apr 27 15:45:23 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './dkjump_rom.sh' script.

./dkjump_rom.sh -reset_run
...
./dkjump_rom.sh -noclean_files

For more information on the script, please type './dkjump_rom.sh -help'.
